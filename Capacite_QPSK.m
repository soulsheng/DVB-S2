...
for l=1:length(Es_N0_dB)
    ...
    H = dvbs2ldpc(R);
    enc = fec.ldpcenc(H);
    %%% Génération d'une séquence de bits  (43200 bits)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%% Modulateur %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Construire un modulateur QPSK
    h1 = modem.pskmod('M', 4, 'PhaseOffset',-pi/4,'SymbolOrder','Gray','InputType','Bit');

    % Matlab modulate function for QPSK
    ...
    %%%%%%%%%%%%%%%%%%%%%%% Filtrage adapté %%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% Filtre de réception ou filtre adaptée %%%
...
figure;
plot(Es_N0_dB,capacite, 'b', 'linewidth', 2);
hold on;
grid on;
